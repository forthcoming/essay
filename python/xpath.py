...
And when a node-set is converted to a string, which happens when it is passed as argument to a string function like contains() or starts-with(), results in the text for the first element only.
...
print(res.xpath('//li[@class="item-0" or @name="test-1"]'))  #[<Element li at 0x1c4e93e97c8>, <Element li at 0x1c4e93f06d8>]
