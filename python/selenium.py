...
'''
print(type(input_button))  # <class 'WebElement'>
...
# selenium操作隐藏元素会报错
# 比如网页的select的style属性是display:none(隐藏),必须改成block才能后续操作,解决办法
...
NUM = 5
hong_chou = 'https://www.3658mall.com/hongchou-detail-202.html'  # 205
