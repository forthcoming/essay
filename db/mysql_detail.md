...
![images](source/artic.png )

Buffer Pool：缓冲池是主内存中的一个区域，里面可以缓存磁盘上经常操作的真实数据，在执行增删改查操作时，先操作缓冲池中的数据（若缓冲池没有数据，则从磁盘加载并缓存），然后再以一定频率刷新到磁盘，从而减少磁盘I0，加快处理速度。

![images](source/artic2.png )
![images](source/artic3.png )
![images](source/artic4.png )
![images](source/artic5.png )


磁盘架构：
![images](source/artic6.png )
![images](source/artic7.png )
![images](source/artic8.png )
...
![images](source/MVCCList.png )

如何确定返回哪一个版本 这是由read view决定返回 undo log 中的哪一个版本。

![images](source/readview0.png )
