...
写完提示词,可以交给模型去润色,效果提升非常明显

对于大模型提示词格式,推荐使用markdown格式
1. 结构化清晰,便于大模型理解提示词的层次结构和重要程度
2. 可读性强,代码块可以清晰地标识示例代码或特定格式,粗体、斜体等格式突出重点信息
3. 大模型友好,现代大模型都经过大量Markdown文本训练，能很好地理解这种格式,结构化的信息有助于模型更准确地解析指令
何时使用纯文本呢?
1. 非常简单的单句提示词
2. 需要严格控制token数量的场景
